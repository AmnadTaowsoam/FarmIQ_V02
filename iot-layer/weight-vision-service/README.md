...
- `HEALTH_STATUS_ENABLED`, `HEALTH_STATUS_INTERVAL_SECONDS`
- `DEVICE_FIRMWARE_VERSION`, `DEVICE_IP`, `DEVICE_SIGNAL_STRENGTH`
- `DEVICE_HEALTH_CAMERA_OK`, `DEVICE_HEALTH_SCALE_OK`, `DEVICE_HEALTH_DISK_OK`
