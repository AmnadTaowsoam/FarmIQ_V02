...
import { DeviceOnboardingPage } from './features/admin/pages/DeviceOnboardingPage';
import { RolesPage } from './features/admin/pages/RolesPage';
import { UserDetailPage } from './features/admin/pages/UserDetailPage';
import { DeviceDetailPage as AdminDeviceDetailPage } from './features/admin/pages/DeviceDetailPage';
import { DataPolicyPage } from './features/admin/pages/DataPolicyPage';
import { NotificationsPage as AdminNotificationsPage } from './features/admin/pages/NotificationsPage';
import { ImpersonatePage } from './features/admin/pages/ImpersonatePage';
import { ContextDebugPage } from './features/admin/pages/ContextDebugPage';
import { PermissionMatrixPage } from './features/admin/pages/PermissionMatrixPage';
import { SyncDashboardPage } from './features/admin/pages/SyncDashboardPage';
import { MqttMonitoringPage } from './features/admin/pages/MqttMonitoringPage';
import { StorageDashboardPage } from './features/admin/pages/StorageDashboardPage';
import { QueueMonitoringPage } from './features/admin/pages/QueueMonitoringPage';
          ...
          <BrowserRouter>
            <ActiveContextProvider>
              ...
              <Route path="/" element={
                ...
                {/* Identity & Access */}
                <Route path="admin/identity/users" element={
                     <RoleGuard allowedRoles={['platform_admin', 'tenant_admin']}>
                         <AdminUsersPage />
                     </RoleGuard>
                } />
                <Route path="admin/identity/users/:userId" element={
                     <RoleGuard allowedRoles={['platform_admin', 'tenant_admin']}>
                         <UserDetailPage />
                     </RoleGuard>
                } />
                <Route path="admin/identity/roles" element={
                     <RoleGuard allowedRoles={['platform_admin', 'tenant_admin']}>
                         <RolesPage />
                     </RoleGuard>
                } />
                <Route path="admin/identity/permission-matrix" element={
                     <RoleGuard allowedRoles={['platform_admin', 'tenant_admin']}>
                ...
                {/* Operations */}
                <Route path="admin/ops/sync" element={
                     <RoleGuard allowedRoles={['platform_admin', 'ops_admin']}>
                         <SyncDashboardPage />
                     </RoleGuard>
                } />
                <Route path="admin/ops/mqtt" element={
                     <RoleGuard allowedRoles={['platform_admin', 'ops_admin']}>
                         <MqttMonitoringPage />
                     </RoleGuard>
                } />
                <Route path="admin/ops/storage" element={
                     <RoleGuard allowedRoles={['platform_admin', 'ops_admin']}>
                         <StorageDashboardPage />
                     </RoleGuard>
                } />
                <Route path="admin/ops/queues" element={
                     <RoleGuard allowedRoles={['platform_admin', 'ops_admin']}>
                         <QueueMonitoringPage />
                     </RoleGuard>
                } />
                <Route path="admin/ops/incidents" element={
                     <RoleGuard allowedRoles={['platform_admin', 'ops_admin', 'support']}>
                         <IncidentsPage />
                     </RoleGuard>
                } />
                ...
                <Route path="admin/devices/:deviceId" element={
                     <RoleGuard allowedRoles={['platform_admin', 'tenant_admin']}>
                         <AdminDeviceDetailPage />
                     </RoleGuard>
                } />
                <Route path="admin/devices/onboarding" element={
                     <RoleGuard allowedRoles={['platform_admin', 'tenant_admin']}>
                ...
                {/* Operations */}
                <Route path="admin/ops/health" element={
                     <RoleGuard allowedRoles={['platform_admin', 'tenant_admin']}>
                         <SystemHealthPage />
                     </RoleGuard>
                } />
                ...
                {/* Settings */}
                <Route path="admin/settings/data-policy" element={
                     <RoleGuard allowedRoles={['platform_admin']}>
                         <DataPolicyPage />
                     </RoleGuard>
                } />
                ...
                {/* Support */}
                <Route path="admin/support/impersonate" element={
                     <RoleGuard allowedRoles={['platform_admin']}>
                         <ImpersonatePage />
                     </RoleGuard>
                } />
                <Route path="admin/support/context-debug" element={
                     <RoleGuard allowedRoles={['platform_admin']}>
                         <ContextDebugPage />
                     </RoleGuard>
                } />
                ...
                <Route path="admin/users" element={<Navigate to="/admin/identity/users" replace />} />
